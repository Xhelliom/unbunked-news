...
// Demo content derived from the design handoff (ui_kits/news_site/data.js),
// expanded into longer article bodies so the feed and reading view have real
// substance to render. Re-runnable: it wipes and re-inserts these slugs only.
//
//   pnpm db:seed-articles

type SeedSource = { url: string; title: string };
...
async function main() {
  ...
  // Idempotent: remove our demo rows first. Cascades drop claims, sources and
  // article/tag links automatically.
